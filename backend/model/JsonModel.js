  ...
  "Veg-Masala-Tadka": {
    ...
    items: [
      ...
      },
      {
        cardId: 2,
        imageId:
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/noc7ieivirqxtpujhsgl",
        title: "UBQ by Barbeque",
        type: "North Indian, Barbeque",
        mealDetail:
          "Succulent barbeque dishes with authentic North Indian spices.",
      ...
      },
      {
        cardId: 3,
        imageId:
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/iydxtay1mnne2ktw7txe",
        title: "Barbeque Nation",
        type: "North Indian, Barbeque",
        mealDetail:
          "Wide range of barbeque options with a buffet style serving.",
      ...
      },
      {
        cardId: 5,
        imageId:
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/91afd7c438fcf1a3b55b97c2fbaa1cfa",
    ...
    items: [
      {
        ...
        mealDetail:
          "Crispy and juicy fried chicken with a secret blend of herbs and spices.",
      ...
      },
      {
        cardId: 4,
        imageId:
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/5/20/349e8d46-3138-4b19-96b2-df400a77e285_622197.JPG",
        title: "Domino's Pizza",
        type: "Pizzas, Italian",
        mealDetail:
          "Hot and fresh pizzas with a variety of toppings and crust options.",
    ...
    items: [
      {
        cardId: 5,
        imageId:
          "https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/4/1/b5c7e325-a2b3-4334-b104-0b20df81dd93_23728.JPG",
        title: "Curry House",
        type: "Indian, Curry",
        mealDetail:
          "A variety of Indian curries with rich and flavorful gravies.",
